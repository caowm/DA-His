...
implementation
function _InputQuery1(const ACaption: string; const APrompts: array of string; var AValues: array of string; CloseQueryFunc: TInputCloseQueryFunc): Boolean;
begin
  Result := InputQuery(ACaption, APrompts, AValues, CloseQueryFunc);
end;
function _InputQuery2(const ACaption: string; const APrompts: array of string; var AValues: array of string; CloseQueryEvent: TInputCloseQueryEvent; Context: TObject): Boolean;
begin
  Result := InputQuery(ACaption, APrompts, AValues, CloseQueryEvent, Context);
end;
function _InputQuery3(const ACaption, APrompt: string; var Value: string): Boolean;
begin
...
begin
  ...
  RegisterHeader(H, 'function InputQuery(const ACaption, APrompt: string; var Value: string): Boolean; overloaded', @_InputQuery3);
